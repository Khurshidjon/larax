...
<head>
    ...
    <!-- =======================================================
      ...
      Author: Ergashev Xurshid
      Author URL: https://larax.uz
    ======================================================= -->
</head>
...
<section id="hero">
    <div class="hero-container">
        <div class="wow fadeIn">
            <div class="hero-logo">
                <img class="" src="{{asset('img/larax.png')}}" alt="Larax">
            </div>
            <h1>Welcome to Larax studio</h1>
...
<header id="header">
    <div class="container">
        ...
        <div id="logo" class="pull-left">
            <a href="#hero"><img src="{{asset('img/larax.png')}}" alt="" title="" /></a>
    ...
    <div class="container wow fadeInUp">
        <div class="row">
            ...
            <div class="col-md-4 subscribe-btn-container">
                <a class="subscribe-btn" href="#" data-toggle="modal" data-target="#myModal">Subscribe Now</a>
            </div>
            <!-- The Modal -->
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Enter your email address for updates</h4>
                            ...
                            <div id="create-item">
                                <form action="{{route('subscribers')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="text" class="form-control form-control{{ $errors->has('subscribers') ? ' is-invalid' : '' }}" value="{{ old('subscribers') }}" type="email" name="subscribers">
                                    ...
                                    <input type="submit" id="subscriberr" class="btn btn-outline-light" value="Subscribe">
                                </form>
                            </div>
                        </div>
                        <!-- Modal footer -->
        ...
        <div class="row">
            <div class="col-md-3 col-md-push-2">
                <div class="info">
                    <div>
                        ...
                        <p>6/7 Yangi Tarnov Street<br>Tashkent, Yunusabad</p>
                    </div>

                    <div>
                        <i class="fa fa-envelope"></i>
                        <p>xurshidjon1607@umail.uz</p>
                    </div>
            ...
            <div class="col-md-5 col-md-push-2">
                <div class="form">
                    ...
                    <form action="{{route('message.contact')}}" method="post" role="form" class="contactForm">
                        @csrf
                        <div class="form-group">
...
<footer id="footer">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="copyright">
                    &copy; Copyright <strong>Larax Studio</strong>. All Rights Reserved
                </div>
                <div class="credits">
                    <!--
                    ...
                    -->
                    Portfolio page by <a href="https://larax.uz/">Larax Studio</a>
                </div>
            </div>
        </div>
    </div>
...
<script src={{asset('css/vanillatoasts.js')}}""></script>
